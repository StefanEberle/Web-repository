...
<div>Vielen Dank für Ihre Bestellung. Anbei sehen Sie die
	dazugehörige Rechnung.</div>

<div>
	<p>
		Rechnungsempfänger:<br /> ${adresse.vorname} ${adresse.nachname}<br />
		${adresse.strasse} ${adresse.hausnummer}<br /> ${adresse.plz}
		${adresse.stadt}
	</p>
</div>

<div>
	Rechnungsnummer: ${rechnung.rechnungID} <br /> Zahlungsart:
	${rechnung.bezahlung}
</div>
