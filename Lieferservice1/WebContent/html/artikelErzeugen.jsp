...
<br>
		<input type="number" step="0.01" name="gesamtpreis" min="0.1" max="999.99" placeholder="Gesamtpreis pro Kasten" required>
<br>
		<input type="number" step="0.01" name="fuelmenge"  min="0.1" max="6.0" placeholder="Füllmenge" required>
<br>
